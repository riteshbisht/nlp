========================================================================
    ACTIVE TEMPLATE LIBRARY : MetaphoneCOM Project Overview
========================================================================

AppWizard has created this MetaphoneCOM project for you to use as the starting point for
...
_MetaphoneCOM.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_MetaphoneCOM.h)
        GUID definitions                                (_MetaphoneCOM_i.c)
        A type library                                  (_MetaphoneCOM.tlb)
        Marshaling code                                 (_MetaphoneCOM_p.c and dlldata.c)
MetaphoneCOM.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named MetaphoneCOM.pch and a precompiled types file named StdAfx.obj.
...
MetaphoneCOMps.vcproj
	...
	dlldata.c, MetaphoneCOM_i.c and MetaphoneCOM_p.c which are required
